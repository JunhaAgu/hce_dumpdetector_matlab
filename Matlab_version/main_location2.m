...
%% P1
z1_1 = (C1*T_21(3,4) - T_21(1,4)) /( A1*(T_21(1,1)-C1*T_21(3,1)) + B1*(T_21(1,2)-C1*T_21(3,2)) + (T_21(1,3)-C1*T_21(3,3)) ) ;
x1_1 = A1* z1_1;
y1_1 = B1* z1_1;
...
%% P2
z2_1 = (C2*T_21(3,4) - T_21(1,4)) /( A2*(T_21(1,1)-C2*T_21(3,1)) + B2*(T_21(1,2)-C2*T_21(3,2)) + (T_21(1,3)-C2*T_21(3,3)) ) ;
x2_1 = A2* z2_1;
y2_1 = B2* z2_1;
...
%% P3
z3_1 = (C3*T_21(3,4) - T_21(1,4)) /( A3*(T_21(1,1)-C3*T_21(3,1)) + B3*(T_21(1,2)-C3*T_21(3,2)) + (T_21(1,3)-C3*T_21(3,3)) ) ;
x3_1 = A3* z3_1;
y3_1 = B3* z3_1;
...
%% P4
z4_1 = (C4*T_21(3,4) - T_21(1,4)) /( A4*(T_21(1,1)-C4*T_21(3,1)) + B4*(T_21(1,2)-C4*T_21(3,2)) + (T_21(1,3)-C4*T_21(3,3)) ) ;
x4_1 = A4* z4_1;
y4_1 = B4* z4_1;

P4_0 = (T_10)^-1*[x4_1 y4_1 z4_1 1]';

% z1_1_ = (D*T_21(3,4) - T_21(2,4)) /( A*(T_21(1,1)-D*T_21(3,1)) + B*(T_21(1,2)-D*T_21(3,2)) + (T_21(1,3)-D*T_21(3,3)) ) ;
% x1_1_ = A* z1_1_;
% y1_1_ = B* z1_1_;
% 
